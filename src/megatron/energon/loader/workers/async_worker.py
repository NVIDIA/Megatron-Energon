...
from typing import Any, Callable, ParamSpec, Protocol, TypeVar, override

from megatron.energon.cache.base import CachePool
from megatron.energon.edataclass import edataclass
from megatron.energon.flavors.base_dataset import SavableDataset
from megatron.energon.loader.future import Future
...
class DataLoaderAsynchronousWorker(DataLoaderWorker[TSample]):
    """

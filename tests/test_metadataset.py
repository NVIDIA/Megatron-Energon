...
def dataset_path(temp_dir):
    ...
    nested_mds_path = dataset_path / "nested_metadataset.yaml"
...
def test_metadataset(dataset_path):
    ...
    val_dataset = get_val_dataset(
        dataset_path / "metadataset.yaml", worker_config=worker_config, batch_size=10
    )
...
def test_nested_metadataset(dataset_path):
    ...
    dataset = load_dataset(dataset_path / "nested_metadataset.yaml")
    ...
    # Train mode dataset
    train_dataset = get_train_dataset(
        dataset_path / "nested_metadataset.yaml",
        worker_config=worker_config,
        batch_size=10,
        shuffle_buffer_size=None,
        max_samples_per_sequence=None,
...
def test_worker_sample_balance(dataset_path):
    torch.manual_seed(42)
...
def test_save_restore_state_train(dataset_path):
    torch.manual_seed(42)
                        ...
                        (
                            {
                                ...
                                "dataset": {
                                    ...
                                    "map_fn_config": {
                                        ...
                                        "training": True,
                                        "_path": str(dataset_path / "ds1"),
                                        "shards": [
                                            {
                                                "name": "parts/data-0.tar",
                                                "count": 10,
                                                "_path": str(dataset_path / "ds1/parts/data-0.tar"),
                                            },
                                            {
                                                "name": "parts/data-1.tar",
                                                "count": 10,
                                                "_path": str(dataset_path / "ds1/parts/data-1.tar"),
                                            },
                                            {
                                                "name": "parts/data-2.tar",
                                                "count": 10,
                                                "_path": str(dataset_path / "ds1/parts/data-2.tar"),
                                            },
                                            {
                                                "name": "parts/data-3.tar",
                                                "count": 10,
                                                "_path": str(dataset_path / "ds1/parts/data-3.tar"),
                                            },
                                            {
                                                "name": "parts/data-4.tar",
                                                "count": 10,
                                                "_path": str(dataset_path / "ds1/parts/data-4.tar"),
                                            },
                                            {
                                                "name": "parts/data-5.tar",
                                                "count": 5,
                                                "_path": str(dataset_path / "ds1/parts/data-5.tar"),
                                            },
                                        ],
                                        "sample_excludes": [],
                                        "shuffle_over_epochs": 6,
                        ...
                        (
                            {
                                ...
                                "dataset": {
                                    ...
                                    "map_fn_config": {
                                        "type": "StandardWebdatasetFactory",
                                        "training": True,
                                        "_path": str(dataset_path / "ds2"),
                                        "shards": [
                                            {
                                                "name": "parts/data-0.tar",
                                                "count": 10,
                                                "_path": str(dataset_path / "ds2/parts/data-0.tar"),
                                            },
                                            {
                                                "name": "parts/data-1.tar",
                                                "count": 10,
                                                "_path": str(dataset_path / "ds2/parts/data-1.tar"),
                                            },
                                            {
                                                "name": "parts/data-2.tar",
                                                "count": 10,
                                                "_path": str(dataset_path / "ds2/parts/data-2.tar"),
                                            },
                                            {
                                                "name": "parts/data-3.tar",
                                                "count": 10,
                                                "_path": str(dataset_path / "ds2/parts/data-3.tar"),
                                            },
                                            {
                                                "name": "parts/data-4.tar",
                                                "count": 10,
                                                "_path": str(dataset_path / "ds2/parts/data-4.tar"),
                                            },
                                            {
                                                "name": "parts/data-5.tar",
                                                "count": 5,
                                                "_path": str(dataset_path / "ds2/parts/data-5.tar"),
                                            },
                                        ],
                                        "sample_excludes": [],
                                        "shuffle_over_epochs": 2,
...
def test_save_restore_state_train_workers(dataset_path):
    torch.manual_seed(42)
...
def test_save_restore_state_val(dataset_path):
    torch.manual_seed(42)
...
def test_blending_randomness(dataset_path):
    import random
...
def test_slice_iter_shuffle_over_epochs(dataset_path):
    torch.manual_seed(42)
...
def test_save_restore_next(dataset_path):
    torch.manual_seed(42)
